...
void log_handler_impl(const char* filename, int line, LogLevel level, const char* fmt, va_list ap);

#define LOG(level, fmt, arg...) \
  sillyrpc::base::log_handler(__FILE__, __LINE__, \
      sillyrpc::base::LOG_LEVEL_##level, fmt, ##arg) \
